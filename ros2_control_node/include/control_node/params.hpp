...
struct ControllerParams
{
  ...
  double w_body_max     = 0.4;   // rad/s, 몸체 각속도 상한 [0623 0.7→0.4: 회전 시 헛돎↓]
  ...
  double yaw_time_limit = 0.16;      // s, 한 방향 누적 명령시간 하드 한계
  double yaw_time_warn  = 0.14;      // s, 이 근처 도달 시 /yaw_limit_warn → UI 빨간선
  ...
  // ------------------------------------------------------------------------
  double kp_pos   = 0.5;    // 위치오차[m] → 속도[m/s] (P 게인) [0623 0.7→0.5: 천천히]
  ...
  // ------------------------------------------------------------------------
  double kp_byaw   = 0.45;  // yaw오차[rad] → 각속도[rad/s] (P) [0623 →0.45: 과회전(오버슈트)↓]
  double kd_byaw   = 0.25;  // yaw 감쇠 (D) [0623 0.1→0.25: 옆이동 시 오버슈트 감쇠]
